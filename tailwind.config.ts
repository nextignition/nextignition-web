  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        badge: ["Space Grotesk", "Inter", "system-ui", "sans-serif"],
      },
      fontSize: {
        "hero": ["3.25rem", { lineHeight: "3.625rem", letterSpacing: "-0.02em" }],
        "display": ["2.5rem", { lineHeight: "2.75rem", letterSpacing: "-0.02em" }],
        "heading": ["1.75rem", { lineHeight: "2.125rem", letterSpacing: "-0.01em" }],
